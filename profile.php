            ...
            <div class="collapse navbar-collapse" id="navbarcontent">
                <ul class="navbar-nav mt-5 pr-5">
                   ...
                   <li class="nav-item active">
                       <a href="./users.php" class="nav-link"><span class="fa fa-address-card fa-lg"> </span>View Customers <span class="sr-only">(current)</span></a>
                   </li>
                   <li class="nav-item">
    ...
    <div class="container" style=" padding-top:200px;"  >
          <div class="row">
             <div class="col-sm offset-md-3 col-md-6">
                  <div class="panel panel-default" style="padding: 10px; color:Black; background-color: #7FFFD4; border-radius: 20px;">
            ...
            <p><button class="btn btn-dark btn-xs view_data" data-toggle="modal" data-target="#transfer<?php echo $row['user_id'] ?>">Click to transfer</button></p> 
                                   </div>
                                </div>
            </div>
            </div>
